...
label three:
    ...
    if sc10two:
        n "Такое изысканное оружие так долго лежало без дела.{w} Это неправильно."
        n "Оружие должно отнимать жизни.{w} А этой я уже давно никого не убивал."
        ...
        g "Такое изысканное оружие так долго лежало без дела. Это неправильно."
        g "Оружие должно отнимать жизни. А этой я уже давно никого не убивал."
...
label for:
    ...
    if sc17one:
        ...
        a "Он чуть меня не убил. Бешеный ублюдок! Сам не ожидал, что смогу так ловко увернуться."
    ...
    menu:
        "Перебить":
            ...
            a "Ты оставил меня, не заботясь о моих чувствах. Так что не требуй и от меня заботы о твоих."
...
# Дед стоит лицом к камину, сжимает шпагу в руках.
            ...
            g "Хочешь прибрать к рукам мой дом? Уже сговорилась со своими немытыми друзьями?"
            ...
            s "Милый, ты не мог это контролировать. Прими это."
            ...
            if sc15two and three:
                ...
                d "Я горжусь тобой, Артур. Ты спас меня и сделал то, что не смог я за всю свою жизнь."
            ...
            s "Как же долго я ждала это лакомого момента. И вот, он настал."
